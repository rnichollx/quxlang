...
namespace
{
    ...
    void register_quxlang_io_types(rpnx::querygraph::ui::graph_dump_node_viewer& viewer)
    {
        ...
        register_type< quxlang::class_field_declaration_list_spec::query_spec::input_type >(viewer);
        register_type< quxlang::class_field_declaration_list_spec::query_spec::output_type >(viewer);
        register_type< quxlang::class_field_list_spec::query_spec::input_type >(viewer);
        register_type< quxlang::class_field_list_spec::query_spec::output_type >(viewer);
        register_type< quxlang::class_layout_spec::query_spec::input_type >(viewer);
        register_type< quxlang::class_layout_spec::query_spec::output_type >(viewer);
        ...
        register_type< quxlang::class_tags_spec::query_spec::input_type >(viewer);
        register_type< quxlang::class_tags_spec::query_spec::output_type >(viewer);
        ...
        register_type< quxlang::type_placement_info_spec::query_spec::input_type >(viewer);
        register_type< quxlang::type_placement_info_spec::query_spec::output_type >(viewer);
