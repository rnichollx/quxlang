...
#ifndef QUXLANG_VM_PROCEDURE_FROM_CANONICAL_FUNCTANOID_RESOLVER_HEADER_GUARD
#define QUXLANG_VM_PROCEDURE_FROM_CANONICAL_FUNCTANOID_RESOLVER_HEADER_GUARD
