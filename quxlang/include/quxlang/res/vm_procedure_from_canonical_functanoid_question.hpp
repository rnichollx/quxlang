...
#ifndef QUXLANG_RES_VM_PROCEDURE_FROM_CANONICAL_FUNCTANOID_QUESTION_HEADER_GUARD
#define QUXLANG_RES_VM_PROCEDURE_FROM_CANONICAL_FUNCTANOID_QUESTION_HEADER_GUARD
