...
namespace quxlang::vmir2
{
    class assembler
    {
      ...
      private:
        ...
        std::string to_string_internal(vmir2::lowering_error error);
        ...
        std::string to_string_internal(vmir2::interface_init inst);
        ...
        std::string to_string_internal(vmir2::constexpr_set_result2 inst);
        std::string to_string_internal(vmir2::constexpr_make_proxy inst);
        std::string to_string_internal(vmir2::constexpr_output_byte inst);
        ...
        std::string to_string_internal(vmir2::load_const_enum inst);
        ...
        /** Formats an owned value relocation. */
        std::string to_string_internal(vmir2::relocate_value inst);
        std::string to_string_internal(vmir2::load_from_ref inst);
        std::string to_string_internal(vmir2::store_to_ref inst);
        std::string to_string_internal(vmir2::compare_exchange inst);
        ...
        std::string to_string_internal(vmir2::struct_init_start sdn);
        std::string to_string_internal(vmir2::struct_init_finish scn);
        std::string to_string_internal(vmir2::destroy dst);
        ...
        std::string to_string_internal(vmir2::bitwise_or op);
        std::string to_string_internal(vmir2::bitwise_xor op);
