...
namespace quxlang
{
    ...
    class compiler
    {
      ...
      private:
        ...
        COMPILER_INDEX(argument_initialize_by_intrinsic)
        COMPILER_INDEX(argument_initialize_by_template)
        COMPILER_INDEX(argument_initialize_by_class_conversion)
        ...
        COMPILER_INDEX(functum_builtins)
        ...
        COMPILER_INDEX(class_requires_gen_assignment)
        ...
        COMPILER_INDEX(user_assignment_exists)
