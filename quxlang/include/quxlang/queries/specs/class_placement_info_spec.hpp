...
namespace quxlang
{
    struct class_placement_info_spec
    {
        ...
        using dependencies = rpnx::typelist< class_type_query, struct_layout_query, enum_info_query, flagset_info_query, machine_info_query, symbol_type_query, class_placement_info_query >;
    };
