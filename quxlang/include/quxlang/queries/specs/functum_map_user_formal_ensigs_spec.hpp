...
namespace quxlang
{
    using functum_map_user_formal_ensigs_spec = rpnx::query_handler_spec< functum_map_user_formal_ensigs_query, rpnx::typelist< functum_list_user_ensig_declarations_query, lookup_query > >;
