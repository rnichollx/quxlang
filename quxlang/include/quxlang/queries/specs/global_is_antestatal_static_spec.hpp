...
namespace quxlang
{
    using global_is_antestatal_static_spec = rpnx::querygraph::query_handler_spec< global_is_antestatal_static_query, rpnx::typelist< symboid_query, symbol_type_query, type_is_antestatal_query, variable_type_query > >;
