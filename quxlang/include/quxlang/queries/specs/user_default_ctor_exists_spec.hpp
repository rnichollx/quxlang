...
namespace quxlang
{
    using user_default_ctor_exists_spec = rpnx::query_handler_spec< user_default_ctor_exists_query, rpnx::typelist< function_ensig_init_with_query, functum_user_overloads_query > >;
