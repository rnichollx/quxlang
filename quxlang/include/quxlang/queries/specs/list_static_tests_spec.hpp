...
namespace quxlang
{
    using list_static_tests_spec = rpnx::query_handler_spec< list_static_tests_query, rpnx::typelist< constexpr_bool_query, symboid_subdeclaroids_query, list_static_tests_query > >;
