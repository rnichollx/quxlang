...
namespace quxlang
{
    using asm_procedure_from_symbol_spec = rpnx::query_handler_spec< asm_procedure_from_symbol_query, rpnx::typelist< extern_linksymbol_query, lookup_query, procedure_linksymbol_query, symboid_query > >;
