...
namespace quxlang
{
    struct static_test_vmir_spec
    {
        ...
        using dependencies = typename append_co_vmir_generator2_dependencies< co_vmir_generator2_query_deps, test_is_enabled_for_static_testing_query, vm_procedure3_query >::type;
    };
