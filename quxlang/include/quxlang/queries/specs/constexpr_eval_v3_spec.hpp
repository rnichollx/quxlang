...
namespace quxlang
{
    struct constexpr_eval_v3_spec
    {
        ...
        using dependencies = rpnx::typelist< antestatal_static_value_query, class_layout_query, constexpr_routine_v3_query, enum_info_query, flagset_info_query, functanoid_indirectly_instantiated_functanoids_query, functanoid_required_class_layouts_query, global_is_antestatal_static_query, source_bundle_query, source_file_index_query, symbol_type_query, variable_type_query, vm_procedure3_query >;
    };
