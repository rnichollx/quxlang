...
namespace quxlang
{
    struct antestatal_static_value_spec
    {
        ...
        using dependencies = rpnx::typelist< constexpr_eval_antestatal_query, global_is_antestatal_static_query, string_static_value_query, symboid_query, variable_type_query >;
    };
