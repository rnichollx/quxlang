...
namespace quxlang
{
    struct bindable_spec
    {
        using query = bindable_query;
        using dependencies = rpnx::typelist< bindable_by_reference_objectization_query, bindable_by_reference_requalification_query, bindable_by_temporary_materialization_query >;
    };
