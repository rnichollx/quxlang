...
namespace quxlang
{
    using symbol_type_spec = rpnx::querygraph::query_handler_spec< symbol_type_query, rpnx::typelist< functum_overloads_query, symboid_query, symbol_type_query, templex_builtins_query > >;
