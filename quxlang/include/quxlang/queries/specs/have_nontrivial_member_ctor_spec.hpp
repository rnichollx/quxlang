...
namespace quxlang
{
    struct have_nontrivial_member_ctor_spec
    {
        ...
        using dependencies = rpnx::typelist< class_builtin_query, class_default_ctor_query, struct_direct_bases_query, struct_field_list_query, have_nontrivial_member_ctor_query >;
    };
