...
namespace quxlang
{
    using functum_initialize_spec = rpnx::querygraph::query_handler_spec< functum_initialize_query, rpnx::typelist< function_instanciation_query, functum_select_function_query > >;
