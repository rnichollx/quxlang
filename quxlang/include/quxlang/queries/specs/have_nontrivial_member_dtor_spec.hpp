...
namespace quxlang
{
    struct have_nontrivial_member_dtor_spec
    {
        ...
        using dependencies = rpnx::typelist< class_builtin_query, class_default_dtor_query, struct_direct_bases_query, struct_field_list_query, class_trivially_destructible_query >;
    };
