...
namespace quxlang
{
    using argument_adaptation_is_better_fit_spec = rpnx::query_handler_spec< argument_adaptation_is_better_fit_query, rpnx::typelist< argument_adaptation_rank_query > >;
