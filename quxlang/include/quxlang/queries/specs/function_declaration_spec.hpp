...
namespace quxlang
{
    struct function_declaration_spec
    {
        ...
        using dependencies = rpnx::typelist< functum_builtin_overloads_query, functum_list_user_overload_declarations_query, functum_map_user_formal_ensigs_query, symbol_type_query >;
    };
