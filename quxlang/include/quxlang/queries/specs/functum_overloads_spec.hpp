...
namespace quxlang
{
    struct functum_overloads_spec
    {
        using query = functum_overloads_query;
        using dependencies = rpnx::typelist< functum_builtin_overloads_query, functum_user_overloads_query >;
    };
