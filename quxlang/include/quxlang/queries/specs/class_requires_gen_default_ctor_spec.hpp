...
namespace quxlang
{
    struct class_requires_gen_default_ctor_spec
    {
        ...
        using dependencies = rpnx::typelist< class_type_query, struct_tags_query, have_nontrivial_member_ctor_query, union_info_query, user_default_ctor_exists_query, variant_info_query >;
    };
