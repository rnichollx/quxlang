...
namespace quxlang
{
    using class_requires_gen_move_ctor_spec = rpnx::querygraph::query_handler_spec< class_requires_gen_move_ctor_query, rpnx::typelist< have_nontrivial_member_ctor_query, user_move_ctor_exists_query > >;
