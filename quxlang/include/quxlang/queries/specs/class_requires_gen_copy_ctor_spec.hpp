...
namespace quxlang
{
    using class_requires_gen_copy_ctor_spec = rpnx::query_handler_spec< class_requires_gen_copy_ctor_query, rpnx::typelist< class_tags_query, user_copy_ctor_exists_query > >;
