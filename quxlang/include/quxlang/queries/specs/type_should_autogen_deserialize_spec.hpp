...
namespace quxlang
{
    using type_should_autogen_deserialize_spec = rpnx::query_handler_spec< type_should_autogen_deserialize_query, rpnx::typelist< type_is_implicitly_datatype_query, user_deserialize_exists_query > >;
