...
namespace quxlang
{
    struct template_instanciation_spec
    {
        ...
        using dependencies = rpnx::typelist< builtin_template_instanciation_query, constexpr_bool_query, constexpr_eval_v3_query, ensig_initialize_query, symbol_type_query, symboid_query, temploid_formal_ensig_query, template_builtin_query >;
    };
