...
namespace quxlang
{
    ...
    using type_symbol = rpnx::variant< void_type, null_type, byte_type, initguard_type, initguard_lock_type, constexpr_proxy, freebound_identifier, builtin_symbol, context_reference, auto_temploidic, decay_temploidic, type_temploidic, absolute_module_reference, subsymbol, subtag_type, int_type, float_type, bool_type, initialization_reference, instanciation_reference, temploid_reference, value_expression_reference, submember, thistype, procedure_type, ptrref_type, attached_type_reference, numeric_literal_type, numeric_literal_any_temploidic, string_literal_type, string_literal_any_temploidic, nvalue_slot, dvalue_slot, array_type, size_type, address_type, type_index_type, readonly_constant, storage, aligned_storage, virtual_storage, array_initializer_type, static_local_ref, static_snapshot_ref, pack_arg_type_ref, decltype_type_ref, typeof_type_ref, composite_type, composite_field_type_ref, public_field_type_ref >;
    ...
    using expression = rpnx::variant< expression_symbol_reference, expression_this_reference, expression_call, expression_thisdot_reference, expression_dotreference, expression_binary, expression_numeric_literal, expression_bit, expression_target, expression_sizeof, expression_string_literal, expression_rightarrow, expression_leftarrow, expression_multibind, expression_unary_postfix, expression_unary_prefix, expression_value_keyword, expression_have_cpu_attribute, expression_char_literal, expression_sizeof, expression_bits, expression_is_signed, expression_is_integral, expression_type_is_layoutless, expression_type_is_polymorphic, expression_same_types, expression_type_index_of, expression_dynamic_type_of, expression_numeric_literal_fits, expression_numeric_literal_binary_op, expression_numeric_literal_negate, expression_typecast, expression_pun, expression_place, expression_new, expression_delete, expression_choose, expression_static_choose, expression_snapshot, expression_pack_size, expression_pack_arg, expression_forward, expression_move, expression_lambda, expression_prepared_lambda, expression_union_is, expression_variant_isa, expression_variant_unwrap, expression_address_launder_discover_existing, expression_address_launder_escape_alloc_region, expression_begin_alloc_region, expression_end_alloc_region, expression_begin_multi_alloc_region, expression_end_multi_alloc_region, expression_resize_multi_alloc_region, expression_begin_dynamic_alloc_region, expression_end_dynamic_alloc_region, expression_resize_dynamic_alloc_region, expression_parent_alloc_address, expression_relocate_region_objects, expression_alignof, expression_composite_literal, expression_composite_operation, expression_public_field_metadata, expression_public_field_get >;
