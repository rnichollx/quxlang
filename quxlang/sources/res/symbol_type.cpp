...
QUX_CO_RESOLVER_IMPL_FUNC_DEF(symbol_type)
{
    ...
    else if ( typeis< numeric_literal_reference >(input_val) || typeis< bool_type >(input_val) || typeis< int_type >(input_val) || typeis< ptrref_type >(input_val) || typeis<nvalue_slot>(input_val) || is_ref(input_val) || typeis<dvalue_slot>(input_val) || typeis< byte_type >(input_val) || typeis< initguard_type >(input_val) || typeis< initguard_lock_type >(input_val)
