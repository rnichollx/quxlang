...
rpnx::querygraph::coroutine< quxlang::global_is_numeric_static_spec > quxlang::global_is_numeric_static_impl(type_symbol input)
{
    ...
    co_return as< readonly_constant >(variable_type).kind == constant_kind::numeric;
}
