...
rpnx::querygraph::coroutine< quxlang::bindable_by_temporary_materialization_spec > quxlang::bindable_by_temporary_materialization_impl(implicitly_convertible_to_input input)
{
