...
rpnx::querygraph::coroutine< quxlang::function_declaration_spec > quxlang::function_declaration_impl(temploid_reference input)
{
    ...
    auto functum_kind = co_await rpnx::querygraph::query_request< symbol_type_query >(functum);
    ...
    auto const& decl_map = co_await rpnx::querygraph::query_request< functum_map_user_formal_ensigs_query >(functum);
    ...
    auto const& decls = co_await rpnx::querygraph::query_request< functum_list_user_overload_declarations_query >(functum);
