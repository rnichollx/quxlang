...
rpnx::querygraph::coroutine< quxlang::class_placement_info_spec > quxlang::class_placement_info_impl(type_symbol input)
{
    ...
    else if (type.template type_is< composite_type >() || type.template type_is< subsymbol >() || type.template type_is< instanciation_reference >() || type.template type_is< builtin_symbol >())
    {
