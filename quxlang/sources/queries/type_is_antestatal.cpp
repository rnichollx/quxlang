...
rpnx::querygraph::coroutine< quxlang::type_is_antestatal_spec > quxlang::type_is_antestatal_impl(type_symbol input)
{
    ...
    if (typeis< numeric_literal_type >(input) || typeis< string_literal_type >(input) || typeis< int_type >(input) || typeis< float_type >(input) || typeis< bool_type >(input) || typeis< byte_type >(input) || typeis< type_index_type >(input))
    {
        co_return true;
    }
