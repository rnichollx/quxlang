...
{
    source_bundle const bundle = co_await rpnx::querygraph::query_request< source_bundle_query >(std::monostate{});
    std::string const source_name = co_await rpnx::querygraph::query_request< module_source_name_query >(input);
