...
namespace quxlang::vmir2::detail
{
    ...
    auto type_might_have_layout(quxlang::type_symbol const& type) -> bool
    {
        ...
        return type.type_is< quxlang::composite_type >() || type.type_is< quxlang::subsymbol >() || type.type_is< quxlang::instanciation_reference >() || type.type_is< quxlang::readonly_constant >() ||
