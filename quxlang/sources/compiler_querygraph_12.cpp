...
auto quxlang::detail::register_compiler_querygraph_handlers_10(compiler_querygraph& querygraph) -> void
{
    ...
    graph.register_handler_function< instanciation_subtag_bindings_spec >(instanciation_subtag_bindings_impl);
    ...
    graph.register_handler_function< subtag_binding_spec >(subtag_binding_impl);
}
