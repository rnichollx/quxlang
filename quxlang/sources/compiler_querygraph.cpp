    ...
    : m_dump_output_path(std::move(dump_output_path))
{
    ...
    m_graph.register_handler_function< implementation_function_map_spec >(implementation_function_map_impl);
    ...
    m_graph.register_handler_function< interface_defaultable_spec >(interface_defaultable_impl);
    m_graph.register_handler_function< interface_slot_list_spec >(interface_slot_list_impl);
