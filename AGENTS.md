...
9. It's recommended to do end-to-end validation by running qxc against the testmodule and then running the resulting test executable for the current OS/platform combination.
