...
| Instance pointer | `MUT->I32` | [Pointers](reference/pointers.md) |
| Array pointer | `MUT=>>I32` | [Pointers](reference/pointers.md) |
| Managed reference | `~>java_object` | [External types](reference/external-types.md) |
