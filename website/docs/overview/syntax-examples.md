...
| Instance pointer | `MUT->I32` | [Pointers](pointers.md) |
| Array pointer | `MUT=>>I32` | [Pointers](pointers.md) |
| GC pointer | `~>java_object` | [External types](external-types.md) |
...
See [Composites](composites.md) for `COMPOSITE_TIE`,
