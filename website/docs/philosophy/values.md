...
One of the core tenets of Quxlang is that _data types_ should be _strongly ordered_. This is true even for data types which are traditionally not strongly ordered, such as floating-point numbers.
