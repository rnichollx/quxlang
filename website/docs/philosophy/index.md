...
Guiding Lights:
  ...
  * _Deterministic Development_. The same version of the compiler should produce the same output given the same input, regardless of the environment in which it is run.
  ...
  * _Don't be helpful_. Also known as "Avoid Causing Problems"; it is better to leave a problem unaddressed than provide a bad solution.
