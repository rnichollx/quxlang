      ...
      public:
        std::string operator()(expression_call const& call)
        {
            ...
            for (auto const& arg : call.args)
            {
                ...
                result += boost::apply_visitor(*this, arg);
                result += "\n";
            }
            current_indent--;
        ...
        std::string operator()(vm_expr_primitive_binary_op const& op)
        {
            ...
            result += "left: ";
            result += boost::apply_visitor(*this, op.lhs);
            result += indent_string();
            result += "right: ";
            result += boost::apply_visitor(*this, op.rhs);
        ...
        std::string operator()(vm_block const& block)
        {
            ...
            {
                result += indent_string();
                result += boost::apply_visitor(*this, unit);
                result += "\n";
            }
            current_indent--;
        ...
        std::string operator()(vm_expr_poison const& poison)
        {
            ...
            result += indent_string();
            result += "type: ";
            result += boost::apply_visitor(*this, poison.type);
            current_indent--;
            result += indent_string();
            result += "} end poison\n";
            return result;
        ...
        std::string operator()(vm_store const& store)
        {
            ...
            result += indent_string();
            result += "what: ";
            result += boost::apply_visitor(*this, store.what);
            result += indent_string();
            result += "where: ";
            result += boost::apply_visitor(*this, store.where);
            current_indent--;
            result += indent_string();
            result += "} end store\n";
            return result;
        ...
        std::string operator()(vm_expr_access_field const& op)
        {
            ...
            result += "type: ";
            result += boost::apply_visitor(*this, op.type);
            current_indent--;
        ...
        std::string operator()(vm_expr_store const& op)
        {
            ...
            result += boost::apply_visitor(*this, op.what);
            result += indent_string() + "where: ";
            result += boost::apply_visitor(*this, op.where);
            current_indent--;
        ...
        std::string operator()(subentity_reference const& ref)
        {
            ...
            result += indent_string();
            result += "parent: ";
            result += boost::apply_visitor(*this, ref.parent);
            result += "\n";
            result += indent_string();
        ...
        std::string operator()(vm_expr_call const& field)
        {
            ...
            {
                result += indent_string();
                result += "arg:" + boost::apply_visitor(*this, arg);
                result += "\n";
            }
            current_indent--;
            current_indent--;
        ...
        std::string operator()(vm_expr_load_address const& field)
        {
            ...
            result += indent_string();
            result += "type: ";
            result += boost::apply_visitor(*this, field.type);
        ...
        std::string operator()(vm_expr_dereference const& field)
        {
            ...
            result += indent_string();
            result += "base: ";
            result += boost::apply_visitor(*this, field.expr);
        ...
        std::string operator()(vm_expr_bound_value const& field)
        {
            ...
            result += indent_string();
            result += "value: ";
            result += boost::apply_visitor(*this, field.value);
            result += indent_string();
            result += "function_ref: ";
            result += boost::apply_visitor(*this, field.function_ref);
            current_indent--;
            result += indent_string() + "}\n";
            return result;
        }
        ...
        std::string operator()(vm_execute_expression const& expr)
        {
            ...
            result += indent_string();
            result += "expr: ";
            result += boost::apply_visitor(*this, expr.expr);
            current_indent--;
            result += indent_string() + "}\n";
            return result;
        }
        ...
        std::string operator()(vm_if const& ifval)
        {
            ...
            result += indent_string();
            result += "condition: ";
            result += boost::apply_visitor(*this, ifval.condition);
            result += indent_string();
            result += "then_block: ";
        ...
        std::string operator()(vm_while const& whileval)
        {
            ...
            result += indent_string();
            result += "condition: ";
            result += boost::apply_visitor(*this, whileval.condition);
            result += indent_string();
            result += "loop_block: ";
        ...
        std::string operator()(instance_pointer_type const& ptr)
        {
            ...
            result += indent_string();
            result += "target: ";
            result += boost::apply_visitor(*this, ptr.target);
            current_indent--;
            result += indent_string() + "}\n";
            return result;
        }
        ...
        std::string operator()(functanoid_reference const& func)
        {
            ...
            result += indent_string();
            result += "callee: ";
            result += boost::apply_visitor(*this, func.callee);
            result += indent_string();
            result += "parameters: ";
            current_indent++;
            for (auto const& param : func.parameters)
            {
                result += indent_string();
                result += "param: ";
                result += boost::apply_visitor(*this, param);
                result += "\n";
            }
            current_indent--;
            current_indent--;
        ...
        std::string operator()(bound_function_type_reference const& ref)
        {
            ...
            result += indent_string();
            result += "object_type: ";
            result += boost::apply_visitor(*this, ref.object_type);
            result += indent_string();
            result += "function_type: ";
            result += boost::apply_visitor(*this, ref.function_type);
            current_indent--;
            result += indent_string() + "}\n";
            return result;
        }
        ...
        std::string operator()(expression_dotreference const& what)
        {
            ...
            result += indent_string();
            result += "base: ";
            result += boost::apply_visitor(*this, what.lhs);
            result += indent_string();
            current_indent--;
            result += indent_string() + "}\n";
            return result;
        ...
        std::string operator()(expression_binary const& what)
        {
            ...
            result += indent_string();
            result += "rhs: ";
            result += boost::apply_visitor(*this, what.rhs);
            result += indent_string();
            current_indent--;
            result += indent_string() + "}\n";
            return result;
