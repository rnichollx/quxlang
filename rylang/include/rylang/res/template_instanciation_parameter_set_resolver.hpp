...
#include <rylang/data/template_instanciation_parameter_set.hpp>

namespace rylang
{
    class template_instanciation_parameter_set_resolver
        : public rpnx::co_resolver_base< compiler, template_instanciation_parameter_set, instanciation_reference >
    {
    public:
