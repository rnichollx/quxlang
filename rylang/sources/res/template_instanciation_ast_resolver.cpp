...
std::string rylang::template_instanciation_ast_resolver::question() const
{
    return "template_instanciation_ast(" + to_string(input_val) + ")";
}

auto rylang::template_instanciation_ast_resolver::co_process(compiler* c, input_type input) -> co_type
{
