...
rpnx::resolver_coroutine< rylang::compiler, std::set< rylang::call_parameter_information > > rylang::list_builtin_functum_overloads_resolver::co_process(compiler* c, qualified_symbol_reference functum)
{
